...
const FormControl = ({meta,input,child, ...props}) => {
    ...
    return (
        <div className = {style.formControl}>
            ...
            {hasError && <div className = {style.innerError}>
...
export const RadioGroup = ({meta,input, ...props}) => {
    return (
        <div className = {style.radioWrapper}>
            <label className = {style.radioBtnValue}><input {...input} {...props} value = 'men' id = {'men'} checked />{'Men'}</label>
            <label className = {style.radioBtnValue}><input {...input} {...props} value = 'women' id = {'women'} checked />{'Women'}</label>
        </div>
    )
}
